(* Extracted from statDataAnal.nb. Definitions preserve original initialization-cell order. *)
(* Generated mechanically; validate in a clean Wolfram kernel before deleting legacy-original/. *)

(* ---- initialization cell 1 | b46ff383-0051-5049-b50c-510212171ab0 ---- *)
checkNewCreatedSymbols[]

(* ---- initialization cell 2 | 8b3a23c7-7913-1249-8a75-da5995eb6053 ---- *)
(*$NewSymbol=Print["\<New symbol: \>",#2,#1]&*)

(* ---- initialization cell 3 | 91643409-30b1-7b48-a873-13b8763d8293 ---- *)
Print["\<*==================================================================================================*\>"];
...
(* ---- initialization cell 6 | b8785b4c-99cf-7d42-be75-73873194c5f7 ---- *)


(* ---- initialization cell 7 | 1678c162-1edd-4744-95a5-83a02521efd4 ---- *)
...
(* ---- initialization cell 8 | 55b1eb23-dd4a-e74c-b880-3b4c94c12684 ---- *)
...
(* ---- initialization cell 9 | 4bcd38f5-be70-154f-9883-2567e68fabcf ---- *)
...
(* ---- initialization cell 10 | 6183307e-a395-c546-b929-b1af65910fdb ---- *)
(*https://www.itl.nist.gov/div898/handbook/eda/section3/eda35b.htm*)
(* Only for normal distribution *)
...
(* ---- initialization cell 11 | 831d241c-b148-a04e-b4ef-815d96aa616e ---- *)
(*https://www.itl.nist.gov/div898/handbook/eda/section3/eda35b.htm*)
...
(* ---- initialization cell 12 | e9482391-bc9e-5144-9acf-11de85fb1495 ---- *)
(*https://www.itl.nist.gov/div898/handbook/eda/section3/eda35b.htm*)
(* Only for normal distribution *)
...
(* ---- initialization cell 13 | ce7cc628-366a-446d-9fad-fc72b424f1fa ---- *)
...
(*ClearAll[sumInQuadr];
sumInQuadr[x__?NumericQ]:=Sqrt[Total[({x})^(2)]];*)
...
sumInQuadr[x_List]:=Sqrt[Total[x^2]];

sumInQuadr[x__]:=Sqrt[Total[{x}^2]];

VerificationTest[{sumInQuadr[3],sumInQuadr[3,4],sumInQuadr[{3,4}],sumInQuadr[{1,2,2}]},{3,5,5,3},TestID->"\<sumInQuadr-backward-compatible\>"]

(* ---- initialization cell 14 | 55dd90e4-1ddb-bd4e-be26-4934407f416b ---- *)
(**)
(**************************************************************************************************)
...
(* ---- initialization cell 15 | 704a90bc-8b84-48b0-a446-f7280c716fcf ---- *)
(*==================================================================================================*)
...
num=Length[z];
(**)
If[num\[LessEqual]4,Print["\< !@#$% displayHistoStats : # of data = \>",num,"\<  ... too few data // Return \>"];Return[$Failed]];
(**)
\[Mu]=Mean[z];
...
(**)
If[\[Sigma]\[LessEqual]0,Print["\< !@#$% displayHistoStats : non positive \[Sigma] = \>",\[Sigma],"\<  // Return \>"];Return[$Failed]];
(**)
...
(* ---- initialization cell 16 | c4e34da6-4ab4-419d-9d23-64685a024be2 ---- *)
...
(* ---- initialization cell 17 | c25d3aaf-a3fa-4adf-a2a8-7e7caf71059a ---- *)
(* APPLICATION *)
...
(* ---- initialization cell 18 | b4a9036e-9777-47d8-a752-645f0a992df3 ---- *)
...
(* ---- initialization cell 19 | 09106e41-8291-4109-82c3-f21637c091e8 ---- *)
(*==================================================================================================*)
(*OLD*)
(*==================================================================================================*)
Clear@statsDisplay;
...
(* ---- initialization cell 20 | f4b14d2e-f63b-4542-a5c7-450662c013ad ---- *)
...
(* ---- initialization cell 21 | c2394ba9-095d-4e93-ad5c-bcd2170e01d8 ---- *)
ClearAll[errorProp];
...
(* ---- initialization cell 22 | a19f844f-4339-5f45-9621-578ff16d994a ---- *)
(*Module[{dx,dy,x,y},
ClearAll[test];
...
(* ---- initialization cell 23 | f5208ba1-9614-4bc4-8dba-f3797541a18e ---- *)
EndPackage[]

(* ---- initialization cell 24 | 7ce4cbda-918b-8045-ab76-701427baafc5 ---- *)
checkNewCreatedSymbols[]

(* ---- initialization cell 25 | 28f6fafc-3c9b-864c-980d-70816adf29b4 ---- *)
endEvalPrintOut[];
